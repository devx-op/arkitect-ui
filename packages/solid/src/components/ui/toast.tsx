import { createToaster, type CreateToasterReturn, Toast, Toaster } from "@ark-ui/solid/toast"
import type { JSX } from "solid-js"
import { cn } from "@/lib/utils"

// Create a toast instance with proper typing
...
const toast = Object.assign(createToast, {
  success: (title: JSX.Element, description?: JSX.Element) => {
    return createToast({ title, description, type: "success" })
  },
  error: (title: JSX.Element, description?: JSX.Element) => {
    return createToast({ title, description, type: "error" })
  },
  warning: (title: JSX.Element, description?: JSX.Element) => {
    return createToast({ title, description, type: "warning" })
  },
  info: (title: JSX.Element, description?: JSX.Element) => {
