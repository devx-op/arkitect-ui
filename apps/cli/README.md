...
arkitect-ui CLI is a command-line tool that enables:
...
arkitect-ui create my-project

# Create React app with authentication and UI
arkitect-ui create --template react-app --features auth,ui my-react-app

# Use pnpm as package manager
arkitect-ui create --template solid-app --pm pnpm my-solid-app
```
...
```bash
arkitect-ui add [options] <component-name>
```

**Options:**

- `-r, --registry <url>`: Registry URL [default: https://registry.arkitect-ui.dev]
...
arkitect-ui add --registry https://my-registry.com --version 1.2.3 card
```

### `init` - Initialize Configuration

Initializes arkitect-ui configuration in the current project.

```bash
arkitect-ui init [options]
```

**Options:**

- `-r, --registry <url>`: Default registry to use
- `-c, --config-file <file>`: Configuration file [default: arkitect-ui.config.json]
...
arkitect-ui init --registry https://my-company-registry.com --force
```
...
```bash
arkitect-ui registry list
```

#### `registry search` - Search Components

```bash
arkitect-ui registry search <query>
```

#### `registry publish` - Publish Component

```bash
arkitect-ui registry publish [options] <component-path>
```
...
3. **Advanced Configuration**
   - arkitect-ui.config.json configuration file
   - Custom registries
